...
partial class Z80
{
    private void Add8BitArithmeticInstructions()
    {
        ...
        _opCodes["ADD A,(HL)"] = () => { Execute_ADD(ReadByteAtExtendedHL(extraIndexCycles: 5)); };
        ...
        _opCodes["ADC A,(HL)"] = () => { Execute_ADC(ReadByteAtExtendedHL(extraIndexCycles: 5)); };
        ...
        _opCodes["SUB (HL)"] = () => { Execute_SUB(ReadByteAtExtendedHL(extraIndexCycles: 5)); };
        ...
        _opCodes["SBC A,(HL)"] = () => { Execute_SBC(ReadByteAtExtendedHL(extraIndexCycles: 5)); };
        ...
        _opCodes["AND (HL)"] = () => { Execute_AND(ReadByteAtExtendedHL(extraIndexCycles: 5)); };
        ...
        _opCodes["OR (HL)"] = () => { Execute_OR(ReadByteAtExtendedHL(extraIndexCycles: 5)); };
        ...
        _opCodes["XOR (HL)"] = () => { Execute_XOR(ReadByteAtExtendedHL(extraIndexCycles: 5)); };
        ...
        _opCodes["CP (HL)"] = () => { Execute_CP(ReadByteAtExtendedHL(extraIndexCycles: 5)); };
        ...
        _opCodes["INC (HL)"] = () =>
        {
            var address = CalculateExtendedHL(extraIndexCycles: 5);
