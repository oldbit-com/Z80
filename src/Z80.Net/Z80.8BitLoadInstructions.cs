...
partial class Z80
{
    ...
    {
        _opCodes[LD_A_n] = () => Registers.A = ReadByteAndMove();
        _opCodes[LD_B_n] = () => Registers.B = ReadByteAndMove();
        _opCodes[LD_C_n] = () => Registers.C = ReadByteAndMove();
        _opCodes[LD_D_n] = () => Registers.D = ReadByteAndMove();
        _opCodes[LD_E_n] = () => Registers.E = ReadByteAndMove();
        _opCodes[LD_H_n] = () => Registers.XH = ReadByteAndMove();
        _opCodes[LD_L_n] = () => Registers.XL = ReadByteAndMove();
        ...
        _opCodes[LD_A_HL] = () => Registers.A = ReadByte(CalculateHLAddress(extraIndexStates: 5));
        _opCodes[LD_B_HL] = () => Registers.B = ReadByte(CalculateHLAddress(extraIndexStates: 5));
        _opCodes[LD_C_HL] = () => Registers.C = ReadByte(CalculateHLAddress(extraIndexStates: 5));
        _opCodes[LD_D_HL] = () => Registers.D = ReadByte(CalculateHLAddress(extraIndexStates: 5));
        _opCodes[LD_E_HL] = () => Registers.E = ReadByte(CalculateHLAddress(extraIndexStates: 5));
        _opCodes[LD_H_HL] = () => Registers.H = ReadByte(CalculateHLAddress(extraIndexStates: 5));
        _opCodes[LD_L_HL] = () => Registers.L = ReadByte(CalculateHLAddress(extraIndexStates: 5));

        _opCodes[LD_HL_A] = () => { WriteByte(CalculateHLAddress(extraIndexStates: 5), Registers.A); };
        _opCodes[LD_HL_B] = () => { WriteByte(CalculateHLAddress(extraIndexStates: 5), Registers.B); };
        _opCodes[LD_HL_C] = () => { WriteByte(CalculateHLAddress(extraIndexStates: 5), Registers.C); };
        _opCodes[LD_HL_D] = () => { WriteByte(CalculateHLAddress(extraIndexStates: 5), Registers.D); };
        _opCodes[LD_HL_E] = () => { WriteByte(CalculateHLAddress(extraIndexStates: 5), Registers.E); };
        _opCodes[LD_HL_H] = () => { WriteByte(CalculateHLAddress(extraIndexStates: 5), Registers.H); };
        _opCodes[LD_HL_L] = () => { WriteByte(CalculateHLAddress(extraIndexStates: 5), Registers.L); };
        _opCodes[LD_MHL_n] = () => { WriteByte(CalculateHLAddress(extraIndexStates: 2), ReadByteAndMove()); };
    }
}