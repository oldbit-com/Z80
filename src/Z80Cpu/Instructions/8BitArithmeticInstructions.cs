...
partial class Z80
{
    private void Add8BitArithmeticInstructions()
    {
        ...
        _opCodes["ADD A,(HL)"] = () => { Execute_ADD(ReadByteAtExtendedHL(extraIndexTicks: 5)); };
        ...
        _opCodes["ADC A,(HL)"] = () => { Execute_ADC(ReadByteAtExtendedHL(extraIndexTicks: 5)); };
        ...
        _opCodes["SUB (HL)"] = () => { Execute_SUB(ReadByteAtExtendedHL(extraIndexTicks: 5)); };
        ...
        _opCodes["SBC A,(HL)"] = () => { Execute_SBC(ReadByteAtExtendedHL(extraIndexTicks: 5)); };
        ...
        _opCodes["AND (HL)"] = () => { Execute_AND(ReadByteAtExtendedHL(extraIndexTicks: 5)); };
        ...
        _opCodes["OR (HL)"] = () => { Execute_OR(ReadByteAtExtendedHL(extraIndexTicks: 5)); };
        ...
        _opCodes["XOR (HL)"] = () => { Execute_XOR(ReadByteAtExtendedHL(extraIndexTicks: 5)); };
        ...
        _opCodes["CP (HL)"] = () => { Execute_CP(ReadByteAtExtendedHL(extraIndexTicks: 5)); };
        ...
        _opCodes["INC (HL)"] = () =>
        {
            ...
            Clock.AddMemoryContention(Registers.Context == RegisterContext.HL ? Registers.HL: address, 1);
